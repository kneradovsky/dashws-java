...
public class ClientConnection {
	...
	Gson gs = new Gson();
	WebSocketServer wsserver=(WebSocketServer)WebSocketServerFactory.getServer();
	...
	public void onMessage(String message) {
		...
		try {
			...
			sendText(format_error(e.getMessage()));
		}
	}
	...
	public void notImplemented(JsonObject obj) {
		String errmsg=format_error("not implemented");
		sendText(errmsg);
	}
	
	public void onSubscribe(JsonObject obj) {
		try {
